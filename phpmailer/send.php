...
*/
  ...
  $mail->Username   = "107700487@qq.com"; //SMTP服务器的用户帐号
  $mail->Password   = "qgvirommezvpbjbd";        //SMTP服务器的用户密码
  $mail->AddReplyTo('107700487@qq.com', '回复'); //收件人回复时回复到此邮箱,可以多次执行该方法
  $mail->AddAddress('107700487@qq.com', '李明'); //收件人如果多人发送循环执行AddAddress()方法即可 还有一个方法时清除收件人邮箱ClearAddresses()
  $mail->SetFrom('107700487@qq.com', '发件人');//发件人的邮箱
